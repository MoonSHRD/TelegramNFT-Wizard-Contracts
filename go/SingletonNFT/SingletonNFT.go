...
//
// Solidity: event ItemCreated(string file_id, uint256 token_id)
func (_SingletonNFT *SingletonNFTFilterer) FilterItemCreated(opts *bind.FilterOpts) (*SingletonNFTItemCreatedIterator, error) {

	logs, sub, err := _SingletonNFT.contract.FilterLogs(opts, "ItemCreated")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event ItemCreated(string file_id, uint256 token_id)
func (_SingletonNFT *SingletonNFTFilterer) WatchItemCreated(opts *bind.WatchOpts, sink chan<- *SingletonNFTItemCreated) (event.Subscription, error) {

	logs, sub, err := _SingletonNFT.contract.WatchLogs(opts, "ItemCreated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
